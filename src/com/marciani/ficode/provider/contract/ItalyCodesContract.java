...
/**
 * This class is the Contract Class for the access to table ItalyCodes in the SQLite database FiCode, via the content provider FiCodeProvider by the path
 * italy_codes.
 *  
...
public final class ItalyCodesContract {
	
	private ItalyCodesContract() {
		
	}
	
	public static final String AUTHORITY = "com.marciani.ficode.provider";
	
	public static final String PATH = "italy_codes";
	
	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + PATH);
	
	public static final String DBNAME = "FiCode";
	
	public static final String TABLE = "ItalyCodes";
	
	public static final class Columns implements BaseColumns {
		public static final String _ID = "_id";
		public static final String NATIONAL_CODE = "nationalCode";
		public static final String CATASTAL_CODE = "catastalCode";
		public static final String PROVINCE = "province";
		public static final String CITY = "city";	
		
		public static final String DEFAULT_SORT_ORDER = CITY + " DESC";
	}
